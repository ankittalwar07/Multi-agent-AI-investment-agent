...
LAYERS = [
    ...
    },
    {
        ...
        "color": "#06b6d4",
        "icon": "",
        "blurb": "AI accelerators (merchant GPUs + hyperscaler TPUs/ASICs) bonded to HBM stacks",
        "examples": ["NVIDIA", "AMD", "Google TPU", "AWS Trainium", "MSFT Maia", "SK Hynix", "Samsung", "Micron"],
        "components": [
